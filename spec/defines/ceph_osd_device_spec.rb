...
"
  ...
  describe 'when the device is empty' do
    ...
    it { should contain_exec('mkfs_device').with(
      'command'   => 'sleep 120 && mkfs.xfs -f -d agcount=8 -l size=1024m -n size=64k /dev/device1',
...
"
  ...
  describe 'when the device is empty' do
    ...
    it { should contain_exec('mkfs_pci-0000:02:00.0-sas-0x500015554964d213-lun-0').with(
      'command' => 'sleep 120 && mkfs.xfs -f -d agcount=8 -l size=1024m -n size=64k /dev/disk/by-path/pci-0000:02:00.0-sas-0x500015554964d213-lun-0-part1',
